...
<section class="shop-sec-container" id="catalogo">
    ...
    <div class="shop-toolbar-flex">
        <div class="shop-search-box">
            ...
            <input type="text" id="shopSearchInput" class="shop-search-input" placeholder="Buscar péptido (ej. Semaglutide, Tirzepatide, BPC-157, NAD+)..." oninput="handleShopSearch()" onkeyup="handleShopSearch()">
        </div>
