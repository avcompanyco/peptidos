    ...
    <?php if (isset($order) && $order) : ?>
      <div class="thankyou-card">
        ...
        <div class="order-details">
          ...
          <table class="order-items-table">
            ...
            <tfoot>
              ...
              <?php foreach ( $order->get_coupons() as $coupon_item ) : 
                  $coupon_code = $coupon_item->get_code();
                  $discount = $coupon_item->get_discount();
              ?>
              <tr>
                <td colspan="2" style="font-size:var(--fs-sm);color:var(--accent);border-bottom:1px solid var(--border-subtle);">Cupón: <strong><?php echo esc_html($coupon_code); ?></strong></td>
                <td style="text-align:right;font-size:var(--fs-sm);color:var(--accent);font-weight:600;border-bottom:1px solid var(--border-subtle);">-$ <?php echo number_format($discount, 0, ',', '.'); ?></td>
              </tr>
              <?php endforeach; ?>
              <tr>
        ...
        <div class="thankyou-actions">
          ...
          <a href="https://wa.me/573189163091?text=<?php echo urlencode('Hola, acabo de realizar el pedido #'.$order->get_order_number().'. Quiero confirmar mi compra.'); ?>" target="_blank" class="btn btn-outline btn-lg">
