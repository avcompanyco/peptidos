...
<div id="mobileNavModal" style="display:none;position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(7,15,30,0.97);backdrop-filter:blur(20px);z-index:99999999;flex-direction:column;align-items:center;justify-content:center;gap:0;font-family:'Inter',system-ui,sans-serif;">
  ...
  <div class="cart-sidebar" id="cartSidebar">
    ...
    <div class="cart-sidebar-footer" style="padding:24px;border-top:1px solid #e2e8f0;">
      ...
      <a href="<?php echo function_exists("wc_get_checkout_url") ? function_exists('wc_get_checkout_url') ? wc_get_checkout_url() : home_url('/checkout/') : home_url("/checkout/"); ?>" class="cart-btn-checkout" style="display:block;width:100%;padding:14px 24px;background:#070f1e;color:#ffffff;border:none;border-radius:10px;font-size:15px;font-weight:800;text-align:center;text-decoration:none;box-sizing:border-box;letter-spacing:0.02em;transition:all 0.25s ease;">Finalizar Compra</a>
      <a href="<?php echo function_exists("wc_get_cart_url") ? function_exists('wc_get_cart_url') ? wc_get_cart_url() : home_url('/cart/') : home_url("/cart/"); ?>" class="cart-btn-view" style="display:block;width:100%;padding:12px 24px;background:transparent;color:#00a8ff;border:1px solid #00a8ff;border-radius:10px;font-size:14px;font-weight:700;text-align:center;text-decoration:none;box-sizing:border-box;margin-top:10px;transition:all 0.25s ease;">Ver mi carrito completo</a>
    </div>
  </div>
