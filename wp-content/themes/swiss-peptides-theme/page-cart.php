    ...
    <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post" id="spCartForm">
      <div class="sp-cart-grid">
        ...
        <div class="sp-cart-summary-card">
          ...
          <div class="sp-research-disclaimer-box" style="background:#ffffff;border:1.5px solid #cbd5e1;border-radius:14px;padding:14px 16px;margin:18px 0;display:flex;align-items:flex-start;gap:12px;box-sizing:border-box;width:100%;">
            <input type="checkbox" id="spResearchDisclaimerCheckCart" class="sp-disclaimer-checkbox" style="width:18px;height:18px;accent-color:#0284c7;cursor:pointer;margin-top:2px;flex-shrink:0;" checked>
            <label for="spResearchDisclaimerCheckCart" style="font-size:0.82rem;color:#334155;line-height:1.5;font-weight:500;cursor:pointer;user-select:none;">
